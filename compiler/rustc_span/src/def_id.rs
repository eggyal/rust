...
#[skip_traversal(
    but_impl_despite_trivial_because = "traversed generically in `rustc_type_ir::PredicateKind<TyCtxt<'tcx>>`",
    but_impl_despite_trivial_because = "present in traversed tuples"
)]
