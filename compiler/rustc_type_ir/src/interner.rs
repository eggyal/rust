...
/// * `Self::Predicate`
///
/// Because users may rely on implementations of this trait to skip traversals of
/// values of type `T`, incorrect implementations could give rise to logic errors
/// that in turn could result in miscompilations. This trait should therefore be
